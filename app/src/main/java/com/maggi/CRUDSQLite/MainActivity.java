...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String []opciones={"Seleccione una opción:","Mouse", "Teclados", "USB", "Monitor", "CPU"};
        ArrayAdapter<String> adapter= new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, opciones);
        SpinnerCate.setPrompt("Selecciona una Opción");
        ...
        toolbar.setSubtitle("Estudiante - Marjorie Ramirez");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_limpiar) {
            ...
            Intent CAT_PRO = new Intent(MainActivity.this, ListViewCategoria_Producto.class);
    ...
    public int SpinnerOP(){
        ...
        if (op.equals("Mouse")){
            ...
            //r.setText(resu);
        }else if (op.equals("Teclados")){
            idCat=2;
            datos.setIdcategoria(idCat);
            //Toast.makeText(this, "Celular", Toast.LENGTH_SHORT).show();
        }else if (op.equals("USB")){
            idCat=3;
            datos.setIdcategoria(idCat);
        }else if (op.equals("Monitor")) {
            idCat=4;
            datos.setIdcategoria(idCat);
        }else if (op.equals("CPU")) {
            idCat=5;
            datos.setIdcategoria(idCat);
        }else if (op.equals("")) {
